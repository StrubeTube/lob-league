...
/* the trade web (Trade Archive) */
.flowwrap{max-width:640px;margin:0 auto}
.tradeweb{width:100%;height:auto;display:block}
.tradeweb .flowedge{opacity:.8;cursor:pointer}
.tradeweb .flowedge:hover{opacity:1}
.tradeweb .flowedge.faded{opacity:.1}
.tradeweb .flownode circle{fill:var(--mint);stroke:var(--bg);stroke-width:2;cursor:pointer}
.tradeweb .flownode.dim circle{fill:var(--line2)}
.tradeweb .flownode text{fill:var(--ink2);font-size:13px;font-weight:600;cursor:pointer}
